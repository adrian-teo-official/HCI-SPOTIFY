                ...
                <div className="card-body text-white">
                    ...
                    <div className="features hidden">
                        ...
                        <ul className="features-list text-truncate small-p">
                            <li>{`Acousticness: ${trackFeatures.acousticness}`}</li>
                            <li>{`Danceability: ${trackFeatures.danceability}`}</li>
                            <li>{`Energy: ${trackFeatures.energy}`}</li>
                            <li>{`Valence: ${trackFeatures.valence}`}</li>
                        </ul>
                    </div>
                </div>
            </div>
